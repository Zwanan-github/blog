...
export default function MDComponents(params: Params) {
  ...
  const style = {
    ...
    backgroundColor: params.transparent
      ? 'transparent'
      : resolvedTheme == 'dark'
        ? '#0a0a0a'
        : '#ffffff',
  ...
  return mount ? (
    <>
      <MdPreview
        id={'md-preview'}
        className={cn('markdown-body', 'w-full', params.className)}
        style={style}
...
function MDSkeleton() {
  return (
    <div className='w-full h-screen rounded-lg flex flex-col gap-4'>
